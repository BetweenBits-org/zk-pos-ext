...
func sampleTierRatios(seed uint8) []t4spec.TierRatio {
...
func tierToLegacy(in []t4spec.TierRatio) [legacyutils.TierCount]legacyutils.TierRatio {
...
func TestComputeUserAssetsCommitment_LegacyParity(t *testing.T) {
	specAssets := []t4spec.AccountAsset{
	...
	got := t4host.ComputeUserAssetsCommitment(specAssets, assetCountTiers)
...
func TestComputeCexAssetsCommitment_LegacyParity(t *testing.T) {
	...
	got := t4host.ComputeCexAssetsCommitment(
		[]t4spec.CexAssetInfo{spec0},
