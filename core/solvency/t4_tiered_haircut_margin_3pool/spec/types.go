...
// the t4_tiered_haircut_margin_3pool solvency model: tier-based collateral haircut,
...
// AccountAsset is the per-user, per-asset 5-tuple of the t4_tiered_haircut_margin_3pool
...
// AccountInfo is the per-user record in the t4_tiered_haircut_margin_3pool model.
...
// CexAssetInfo is the per-asset global state in the t4_tiered_haircut_margin_3pool model.
