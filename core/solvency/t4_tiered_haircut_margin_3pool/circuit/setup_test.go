...
func (testNoopModule) Define(_ frontend.API, _ t4spec.ConstraintContext) error {
	return nil
}

// TestSetupSmoke_AlphaNoopBaseline compiles the t4_tiered_haircut_margin_3pool circuit
