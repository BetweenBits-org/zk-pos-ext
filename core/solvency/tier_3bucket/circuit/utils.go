...
// checkAndGetIntegerDivisionRes is the tier_3bucket specialisation of
...
// supplies them.
func calcAndSetCollateralInfo(assetIndex int, ua *UserAssetInfo, um *tier3spec.AccountAsset, cexInfo []tier3spec.CexAssetInfo) {
...
func pickTier(collateralValue *big.Int, ratios []tier3spec.TierRatio) (int, int) {
	for i := range ratios {
