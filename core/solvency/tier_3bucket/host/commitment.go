...
// tier_3bucket solvency model. Pairs with the sibling spec/ (data
...
// tier_3bucket 6-tuple, the 3-bucket commitment packing, the tier
...
// of the tier_3bucket trusted-setup contract — changing it forks .vk.
func ComputeUserAssetsCommitment(assets []tier3spec.AccountAsset, assetCountTiers []int) []byte {
...
func getAssetsCountOfUser(assets []tier3spec.AccountAsset, assetCountTiers []int) int {
	count := len(assets)
...
func paddingAccountAssets(assets []tier3spec.AccountAsset, assetCountTiers []int) []uint64 {
	targetCounts := getAssetsCountOfUser(assets, assetCountTiers)
...
func convertAssetInfoToBytes(a tier3spec.CexAssetInfo) [][]byte {
...
func convertTierRatiosToBytes(ratios []tier3spec.TierRatio) [][]byte {
...
func reservedTierRatios() []tier3spec.TierRatio {
