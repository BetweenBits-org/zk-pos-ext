...
// ConstraintModule is the tier_3bucket-typed extension hook for
// adding stricter or exchange-specific zk-constraints on top of the
// base tier_3bucket circuit.
//
...
// the resulting .pk/.vk are unique to the (tier_3bucket, module)
...
// ConstraintContext is the read-only view of tier_3bucket standard
