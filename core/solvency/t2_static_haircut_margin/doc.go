// Package t2_static_haircut_margin is the Pro-tier variant A solvency model.
//
...
//
// Distinguishes from t3_tiered_haircut_margin_1pool only in using a single haircut
