...
// spot_simple model. AccountID is the raw account-id bytes;
...
// proof under the spot_simple model. The prover service converts it
...
// be sorted ascending. Matches the tier_3bucket helper of the same
