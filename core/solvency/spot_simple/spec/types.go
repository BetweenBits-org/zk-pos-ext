...
// the spot_simple solvency model: single-balance-per-asset user state
...
//
// Differences vs tier_3bucket/spec (intentional simplifications):
...
//     consistency with tier_3bucket; typical case is noop)
package spec

import "math/big"

// AccountAsset is the per-user, per-asset 1-tuple of the spot_simple
...
// AccountInfo is the per-user record in the spot_simple model. No debt
...
// CexAssetInfo is the per-asset global state in the spot_simple model.
