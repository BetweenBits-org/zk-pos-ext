...
// record a baseline R1CS hash for the spot_simple circuit.
//
// Unlike tier_3bucket's setup_test, there's no legacy reference to
// compare against — spot_simple is a zkpor-native model. The R1CS hash
...
// tier_3bucket; same intent, model-typed.
