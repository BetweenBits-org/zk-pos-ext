...
// DecodeAndProve — T3 variant. See t4 host docstring for full notes.
func DecodeAndProve(
	encodedWitness []byte,
	...
	circuitWitness, err := t3circuit.SetBatchCreateUserCircuitWitness(witnessForCircuit, assetCountTiers)
	if err != nil {
	...
	verifyWitness := t3circuit.NewVerifyBatchCreateUserCircuit(witnessForCircuit.BatchCommitment)
