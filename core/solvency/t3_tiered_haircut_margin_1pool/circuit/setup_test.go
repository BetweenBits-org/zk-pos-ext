...
func (testNoopModule) Define(_ frontend.API, _ t3spec.ConstraintContext) error {
	return nil
}

// TestSetupSmoke_AlphaNoopBaseline compiles the t3_tiered_haircut_margin_1pool circuit
