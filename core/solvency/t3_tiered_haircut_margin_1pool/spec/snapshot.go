...
// totals for a single PoR snapshot under the t3_tiered_haircut_margin_1pool model.
//
...
type SnapshotSource interface {
	...
	// risk policy (per-asset tier curve), computed from the real
	// per-asset tiers before capacity/tier padding — the authorization
