...
// t1_simple_margin solvency model: single-balance-per-asset per-user state
...
// (all-zero) account leaf encoding. Identical value to t4_tiered_haircut_margin_3pool's
...
// from t4_tiered_haircut_margin_3pool/circuit/constants.go intentionally — this is the
