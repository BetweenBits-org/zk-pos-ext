...
// ConstraintModule is the t1_simple_margin-typed extension hook for adding
// stricter or exchange-specific zk-constraints on top of the base
// t1_simple_margin circuit. Mirrors t4_tiered_haircut_margin_3pool/spec.ConstraintModule in
...
// the resulting .pk/.vk are unique to the (t1_simple_margin, module) pair.
