...
// DecodeAndProve — see t4_tiered_haircut_margin_3pool/host.DecodeAndProve
// docstring; the T1 variant differs only in the model-typed
// SetBatchCreateUserCircuitWitness + NewVerifyBatchCreateUserCircuit
// imports.
func DecodeAndProve(
	encodedWitness []byte,
	...
	circuitWitness, err := t1circuit.SetBatchCreateUserCircuitWitness(witnessForCircuit, assetCountTiers)
	if err != nil {
	...
	verifyWitness := t1circuit.NewVerifyBatchCreateUserCircuit(witnessForCircuit.BatchCommitment)
