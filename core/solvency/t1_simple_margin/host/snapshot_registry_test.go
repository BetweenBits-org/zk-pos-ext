...
func stubFactory(string, string, int) t1spec.SnapshotSource { return nil }
...
func TestSnapshotRegistry_RegisterAndLookup(t *testing.T) {
	...
	if got := t1host.NewSnapshot(id, "/tmp", "snap", 5); got != nil {
...
func TestSnapshotRegistry_NewSnapshotPanicsOnMissing(t *testing.T) {
	...
	t1host.NewSnapshot("never_registered.v0", "/tmp", "snap", 5)
}
