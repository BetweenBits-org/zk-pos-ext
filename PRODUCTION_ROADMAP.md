...
| **G4** catalog stability 선언 | deferred | R7 | 4-tier 잠정 확정 (R6 통합: T1~T4). **회로 구현 4/4 완료** (T1 R6/A-B, T4 R3, T2 + T3 R6 follow-up). bw6 env fix (R6.5) 후 setup smoke + R1CS baseline 기록 + profile descriptor schema freeze 가 R7 entry 잔여 항목. | R6.5 env fix → R7 entry. |
